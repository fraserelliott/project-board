...
public partial class MarkdownView : UserControl
{
    ...
    {
        string bodyHtml = Markdig.Markdown.ToHtml(markdown ?? string.Empty, _pipeline);
    ...
    {
        string path = Path.Combine(AppContext.BaseDirectory, "Assets", "Markdown", "github-markdown-dark.css");
    ...
    public static readonly DependencyProperty ViewModeProperty = DependencyProperty.Register
        (nameof(ViewMode), typeof(MarkdownViewMode), typeof(MarkdownView), new PropertyMetadata(MarkdownViewMode.Rendered, OnViewModeChanged));
